# 媒体播放器扩展（v1.4.1 完整优化版）

基于 SillyTavern 老版本图片播放器（v1.3.0）深度重构，安全集成全媒体播放能力，聚焦稳定性修复与功能优化，保留老版本核心交互逻辑，同时解决新版本潜在的脚本崩溃、状态不同步等问题，适配多系统环境。
...
**1. 服务连接失败**
- 症状：设置面板显示「服务离线」
- 解决：确认 `image_service.py` 已启动，检查服务地址，重启服务
